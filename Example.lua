...
main:CreateSlider("Slider", 1, 100, function(amount) --pretty much a textfunction, 1st param is the name, 2nd is the minumum, 3rd is the max, and 4th is the callback
	print(amount)
