--Written by Proxide/Tsunamix

--I made this seperate incase i fucked something up lol
...
function library:Create(Name)
	...
	function _Gui:CreateTab(Name)
		...
		function _Tabs:CreateDropdown(Name, ZIndex)
			ZIndex = ZIndex or 5;
			...
			function _Dropdown:AddButton(Name, ClosesWhenClicked, Callback)
